...
const ProjectDetails = () => {
  ...
  return (
        ...
        <div>
          {
            withdrawReq?
              withdrawReq.length > 0?
                <div>
                  <h1 className="font-sans text-xl text-gray font-semibold">Yeu cau rut tien</h1>
                  {
              ...
              :<p>khong tim thay yeu cau rut tien</p>
            :<Loader/>
          }
    ...
    <div className="card lg:w-5/12 h-screen my-4 overflow-y-hidden hover:overflow-y-auto">
        <h1 className="font-sans font-bold text-xl">tat ca nhung nguoi dong gop</h1>
        {
          contributors?
            contributors.length > 0?
              ...
              :<p>khong tin thay nguoi dong gop</p>
            :<Loader/>
        }
