  ...
  const withdrawBalance = (reqId) =>{
    setBtnLoader(reqId)
      ...
      const onSuccess = () =>{
        ...
        toastSuccess(`Da vote thanh cong cho yeu cau ID ${reqId}`)
      }
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row">
      <div className="inner-card my-6 w-full lg:w-2/5">
        <p className="text-md font-bold font-sans text-gray">So tien yeu cau</p>
        <p className="text-sm font-bold font-sans text-gray-600 ">{props.amount} ETH </p>
        <p className="text-md font-bold font-sans text-gray">Tong vote</p>
        <p className="text-sm font-bold font-sans text-gray-600 ">{props.totalVote}</p>
      </div>
      <div className="inner-card my-6 w-full lg:w-3/5">
        <p className="text-md font-bold font-sans text-gray">Dia chi nguoi nhan</p>
